...
class Honeybadger::Agent
  ...
  # @return self
  #
  # source://honeybadger//lib/honeybadger/agent.rb#311
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/agent.rb#285
  def breadcrumbs; end
  ...
  #   otherwise.
  #
  # source://honeybadger//lib/honeybadger/agent.rb#194
  def check_in(id); end

  # Clear all transaction scoped data.
  #
  # source://honeybadger//lib/honeybadger/agent.rb#267
  def clear!; end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/agent.rb#369
  def config; end
  ...
  #
  # source://honeybadger//lib/honeybadger/agent.rb#261
  ...
  #   data is flushed).
  #
  # source://honeybadger//lib/honeybadger/agent.rb#352
  def flush; end
  ...
  # @return [Hash, nil]
  #
  # source://honeybadger//lib/honeybadger/agent.rb#279
  def get_context; end
  ...
  #
  # source://honeybadger//lib/honeybadger/agent.rb#122
  def notify(exception_or_opts = T.unsafe(nil), opts = T.unsafe(nil), **kwargs); end
  ...
  #
  # source://honeybadger//lib/honeybadger/agent.rb#363
  ...
  #   otherwise.
  #
  # source://honeybadger//lib/honeybadger/agent.rb#213
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/agent.rb#440
  def worker; end

  private

  # source://honeybadger//lib/honeybadger/agent.rb#462
  def context_manager; end

  # source://honeybadger//lib/honeybadger/agent.rb#477
  def init_worker; end

  # source://honeybadger//lib/honeybadger/agent.rb#467
  def push(object); end

  # source://honeybadger//lib/honeybadger/agent.rb#472
  ...
  # source://honeybadger//lib/honeybadger/agent.rb#481
...
class Honeybadger::Backend::Base
  ...
  #
  # source://honeybadger//lib/honeybadger/backend/base.rb#114
  def config; end
end
...
class Honeybadger::Config::Ruby < ::Honeybadger::Config::Mash
  ...
  # source://honeybadger//lib/honeybadger/config/ruby.rb#110
  def exception_filter(&block); end

  # source://honeybadger//lib/honeybadger/config/ruby.rb#119
  def exception_fingerprint(&block); end
  ...
  # source://honeybadger//lib/honeybadger/config/ruby.rb#130
...
class Honeybadger::Worker
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/worker.rb#245
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/worker.rb#249
